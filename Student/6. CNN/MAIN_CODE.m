...
%%   Algorithm gor P-Wave detection
stw = 1;     
ltw = 62;    
thresh = 4 ;  
thresh1 = 3;
...
[pk2,t22] = CNN_ANALYSIS(Acc_NS_dlycompensated,Fs,'MinPeakHeight',pkHts*max(Acc_ver_dlycompensated),'Npeaks',1);
[pk3,t33] = CNN_ANALYSIS(Acc_EW_dlycompensated,Fs,'MinPeakHeight',pkHts*max(Acc_ver_dlycompensated),'Npeaks',1);
